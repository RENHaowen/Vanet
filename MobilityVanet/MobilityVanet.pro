...
### ------------------------------------->
INCLUDEPATH += "$$PWD/include" $$PWD/../geologic-core/include $$PWD/../libgeologic-gui $$PWD/../geologic-osm
...
### ------------------------------------->
win32: DEPENDPATH += c:/msys/1.0/local/include $$PWD/../geologic-core/include $$PWD/../libgeologic-gui $$PWD/../geologic-osm
### -------------------------------------<
